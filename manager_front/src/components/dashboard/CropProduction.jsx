...
import GraphCropProductionMonth from "./GraphCropProductionMonth";
import GraphCropProductionDay from "./GraphCropProductionDay";
...
function GraphCropProduction({ currentDate }) {
  ...
  return (
    <S.Wrap>
      ...
      <S.GraphWrap>
        {isSelectedLeft && <GraphCropProductionDay />}
        {isSelectedRight && <GraphCropProductionMonth />}
      </S.GraphWrap>
    </S.Wrap>
  );
}

export default GraphCropProduction;
